...
std::ostream &operator << (std::ostream &, const std::pair<const ElfObject &, std::shared_ptr<const ElfSection>>);
...
std::ostream &operator << (std::ostream &, std::tuple<const ElfObject &, std::shared_ptr<const ElfSection>, const Elf_Sym *> &);
